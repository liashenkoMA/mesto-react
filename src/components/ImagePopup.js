export function ImagePopup(props) {
  ...
  return (
    <div className={`popup popup_type_images-open ${props.card === undefined ? '' : 'popup_opened'}`}>
      <div className="popup__images-conteiner">
        ...
        <figure className="popup__images">
          <img
            src={props.card === undefined ? '' : props.card.link}
            alt={props.card === undefined ? '' : props.card.name}
